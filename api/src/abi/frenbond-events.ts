...
//   `event TreasuryClosed(uint256 indexed _treasuryID, uint8 indexed _status, uint8 indexed _winningBond, uint256 _startingPrice, uint256 _ftPrice, uint256 _maturityPrice, uint256 _quoteBalanceToShare, uint256 _winningBondSupply, uint256 _winningPayout, uint256 _timestamp)`,
//   `event TreasuryClosedWithoutTrade(uint256 indexed _treasuryID, uint8 indexed _status, uint256 _timestamp)`,
...
//   `event TreasuryRefunded(uint256 indexed _treasuryID, uint8 indexed _status, uint256 indexed _pausedAt)`,
// ]);

export const address = "0x5767C841d927cdec5B7d50869a3B3D400f6ad518";
